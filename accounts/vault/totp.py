...
class TOTP ():
    ...
    def create_key(
        ...
        api_path = utils.format_url(
            "{mount_point}/keys/{name}", mount_point=mount_point, name=name
        )
    ...
    def list_keys(
        ...
        """
        api_path = utils.format_url(
            "{mount_point}/keys", mount_point=mount_point
        )
    ...
    def generate_code(
        ...
        """
        api_path = utils.format_url(
            "{mount_point}/code/{name}", mount_point=mount_point, name=name
        )
        return self._client.read(
            path=api_path,
        )
